...
**Stateful objects** hold mutable data that can change over time; they require synchronisation in multithreading. **Stateless objects** hold no mutable data and return results based solely on input arguments; they are inherently thread-safe and easy to test.
